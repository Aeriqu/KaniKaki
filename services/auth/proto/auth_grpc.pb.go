...
const (
	Auth_ChangePassword_FullMethodName = "/aeriqu.kanikaki.auth.Auth/ChangePassword"
	Auth_Login_FullMethodName          = "/aeriqu.kanikaki.auth.Auth/Login"
	Auth_Logout_FullMethodName         = "/aeriqu.kanikaki.auth.Auth/Logout"
	Auth_RefreshToken_FullMethodName   = "/aeriqu.kanikaki.auth.Auth/RefreshToken"
	Auth_Signup_FullMethodName         = "/aeriqu.kanikaki.auth.Auth/Signup"
	Auth_ValidateToken_FullMethodName  = "/aeriqu.kanikaki.auth.Auth/ValidateToken"
)
